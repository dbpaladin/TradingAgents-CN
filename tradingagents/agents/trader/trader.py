...
- 如果基本面偏多、资金面偏空、题材面偏弱，必须明确解释冲突如何裁决
- 如果北向资金、融资融券、机构席位等信息缺失，必须写明“资金证据不完整”，并降低置信度，不得把缺失当成看空实锤
- “资金证据不完整”只能触发降置信度、降仓位或等待确认，除非同时存在明确负面资金证据，否则不能仅因缺口就把结论翻成卖出/强空
- 如果资金面报告明确提示“低样本弱证据”或“日期未对齐”，只能把相关证据当成辅助项，不能作为单独的核心看空依据
- 如果技术/情绪仍偏强，而资金、题材、基本面结论彼此冲突，默认优先输出“持仓者减仓观察、空仓者等待确认”，不要直接跳成强卖出
- 只有在出现至少两类独立负面证据同时成立时，才适合直接给出明确卖出：例如基本面明显高估 + 资金面真实偏空，或题材退潮 + 技术破位
- 对A股题材判断必须优先使用：主线核心 / 主线外延 / 非主线，禁止把“主线外延”误写成“无主线关联”
...
- 总长度控制在 700 字以内
- 不要重复大段背景资料
- 重点保留：建议、目标价、止损/风控、核心理由、持仓者建议、空仓者建议
