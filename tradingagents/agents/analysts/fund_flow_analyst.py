...
- 必须区分“真实偏空”和“数据缺口/口径不适用/当日未更新”
- 如果北向、融资、机构席位等数据缺失，只能降低结论置信度，不能直接写成“中线资金已否定该股”
- 若已有龙虎榜或主力资金的正负方向证据，必须与“缺失项”分开描述，禁止把缺失信息覆盖已有证据
- 如果龙虎榜近一月上榜次数小于等于 1 次，必须明确标注为“低样本弱证据”，只能描述为短线兑现/活跃线索，不能单独推导中期派发或趋势反转
- 如果报告里出现“数据源体检 / 弱证据项 / 有效交易日”，必须主动使用这些信息约束结论强度，禁止忽略体检提示直接下强结论
