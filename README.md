...
- [A股回测指南](./docs/guides/a-share-backtest-guide.md)
...
提交涉及功能、配置、部署或运维行为变化的改动时，请同步更新相关文档。具体规则见 [CONTRIBUTING.md](./CONTRIBUTING.md) 和 [文档更新策略](./docs/maintenance/documentation-update-policy.md)。
